...
export default function NewClientPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (result.success) {
      ...
      setError(result.error || 'Ocurrió un error al añadir el cliente');
      setLoading(false);
    }
  };
  ...
  return (
    <div className="p-8 space-y-6 max-w-4xl mx-auto pb-24">
      <Link href="/admin/clients" className="text-blue-500 hover:text-blue-400 flex items-center gap-2 text-sm font-medium w-fit">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-neutral-400 mt-1">Completa los datos para dar de alta a un nuevo cliente en el sistema.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 md:p-8 space-y-8 shadow-xl">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1 max-w-sm">
              ...
              <p className="text-xs text-neutral-500 mt-2">Formatos recomendados: JPG, PNG. Tamaño ideal: 500x500px.</p>
            </div>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-2">
              <label className="text-sm font-medium text-neutral-400">Peso Inicial (kg)</label>
              <input
                type="number"
                step="0.1"
                required
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-neutral-500 mb-2">Este es el código que usará el cliente para iniciar sesión en su portal.</p>
              <input
                type="text"
                required
